...
<script type="text/javascript">
 ...
 <script type="text/javascript">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-clipboard"></i>&nbsp;Finished Product</h1>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title text-light-blue">Add Finished Product</h3>
            </div>
	    <?php echo "<font style=color:#00468E; font-weight:bold text-align:center;>".$this->session->flashdata('record_update')."</font>"; ?>
	    
            <form role="form" id="FinishedProductForm" action='<?php echo base_url("FinishedProducts/SaveFinishedProduct") ?>' method="post">
	    
	    <div class="box-body">
	      <div class="row invoice-info">
		<div class="col-sm-6 invoice-col">
		  <address>
		    <strong>Finished Product Id:</strong><br>
		...
		<div class="col-sm-6 invoice-col">
		  <address>
		    ...
		    <input class="form-control" name="ProductionNo" type="text" style="width:37%; height:29px;" value="" autocomplete="off">
		  </address>
		</div>
		<div class="col-sm-6 invoice-col">
		  <address>
		    <strong>Finished Date:</strong><br>
		    <input class="form-control" name="FinishedDate" id="datepicker" type="text" style="width:37%; height:29px;" value="<?php echo date("m/d/Y"); ?>" autocomplete="off">
		  </address>
		</div>
		<div class="col-sm-6 invoice-col" style="border: 0px solid;">
		  <address>
		    <strong>Mill Serial #:</strong><br>
		    <input class="form-control" name="MillSerialNo" type="text" style="width:37%; height:29px;" value="" autocomplete="off">
		  </address>
		</div>
		<div class="col-sm-6 invoice-col" style="border: 0px solid;">
		  <address>
			...
			<option value="<?php echo $ProductRecord['ProductId']; ?>"><?php echo $ProductRecord['ProductName'];?></option>
			<?php } ?>
		      </select>
          </address>
		</div>
		<div class="col-sm-6 invoice-col" style="border: 0px solid;">
		  <address>
		    ...
		    <input class="form-control" name="Shift" type="text" style="width:37%; height:29px;"autocomplete="off">
		  </address>
		</div>
	    <?php
		$SNo=1;
		...
		<div class="col-md-12">
		  <div class="box-body pad table-responsive">
		    ...
		    <option value="<?php echo $ProductQualitiesRecord['ProductQualityId']; ?>"><?php echo $ProductQualitiesRecord['ProductQuality'];?></option>
		    <?php } ?>
		    </select>
		    </td>
		    <td style='padding:5px; width:5%;'><input type="number" step="0.01" style="width:100%; text-align:right;" name="ReelSize[]" id="ReelSize_<?php echo $SNo; ?>" autocomplete='off'></td>
		    <td style='padding:5px; width:5%;'><input type='number' style='width:100%;text-align:right;' name='Quantity[]' class='Quantity' id='Quantity_<?php echo $SNo; ?>' autocomplete='off'></td>
		    <td style='padding:5px; width:5%;'><input type='number' style='width:100%;text-align:right;' name='Weight[]' class='Weight' id='Weight_<?php echo $SNo; ?>' autocomplete='off'></td>
		    ...
		    <span style='color:red;' id='remove_".$SNo."' class='fa fa-times-circle'></span>
		     ...
		     <input type="hidden" name="counter" id="counter" class="form-control" value="<?php echo $SNo; ?>">
			...
			<td colspan="4" style="width:19%; text-align:right; font-weight:600;">Total Weight</td>
		      <td style="width:4%;"><div id="TotalWeight" style='font-weight:600; color:#3333CC; text-align:right;'></div></td>
		...
		<div class="row">
		  <!-- <div class="col-md-12">
		    <div class="form-group">
		      <label for="FinishedProductNote" class="col-sm-2 control-label">FinishedProduct Note:</label>
		  		<div class="input-group">
		  		<textarea name="FinishedProductNote" class="form-control" rows="2" cols="60"></textarea>
		      </div>
		    </div>
		  </div> -->
		  <div class="col-md-2">
 ...
 /*  $(function(){
     ...
     $("#FinishedProductForm").on("submit",function(e){
 ...
 $(function(){
  ...
  $(document).on('keyup','input[id^=ProductId]',function(){
    ...
    $.ajax({
        url: "<?php echo site_url('FinishedProduct/AutoCompleteSearch_ProductName')?>",
