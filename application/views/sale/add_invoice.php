...
?>
  ...
  <div class="content-wrapper">
    ...
    <input type="hidden" name="ReferenceName" id="ReferenceName" />
        <input type="hidden" name="isQuatation" id="isQuatation" value="<?php echo $Sales->SaleId; ?>" />
...
<table class='table table-bordered' id="Sale_EntriesTable" style="width: 100%; border-collapse: separate; border-spacing: 0;">
    <thead>    
        <tr style="background: linear-gradient(to bottom, #f8f9fa, #e9ecef);">
            ...
            <th style="width: 5%; padding: 10px; border-top: 1px solid #dee2e6; border-bottom: 2px solid #dee2e6; font-weight: 600; color: #495057;">Product Code</th>
            ...
            <th style="padding: 10px; width: 10%; text-align: left; border-top: 1px solid #dee2e6; border-bottom: 2px solid #dee2e6; font-weight: 600; color: #495057;">HS Code</th>
            <th style="padding: 10px; width: 10%; text-align: left; border-top: 1px solid #dee2e6; border-bottom: 2px solid #dee2e6; font-weight: 600; color: #495057;">UOM</th>
            <th style="padding: 10px; width: 10%; text-align: left; border-top: 1px solid #dee2e6; border-bottom: 2px solid #dee2e6; font-weight: 600; color: #495057;">Last P Price</th>
            <th style="padding: 10px; width: 10%; text-align: left; border-top: 1px solid #dee2e6; border-bottom: 2px solid #dee2e6; font-weight: 600; color: #495057;">Last S Price</th>
...
// 		print_r($Record); die();
		?>
		  ...
		  <tr class="txtMult">
      <td><?php print $SNo; ?></td>
      <td><input style="width:100px;" type="text" id="txtCode<?php print $SNo; ?>" value="<?php echo $Record['ProductBarCode'];?>" name="ProductBarCode[]"></td>
      <td>
        <input style="width:100px;" type="text" id="ProductId<?php print $SNo; ?>" value="<?php echo $Record['ProductName'];?>" name="ProductName[]">
        <input type="hidden" id="hdnProductId<?php print $SNo; ?>" class="hdnProductId"  value="<?php echo $Record['ProductId'];?>" name="hdnProductName[]">
      </td>
      <td style="text-align:center;">
        <input style="width:100%;" type="text" id="LocationName_<?php print $SNo; ?>" name="LocationName_[]">
        <input type="hidden" id="hdnLocationName_<?php print $SNo; ?>" name="LocationId[]">
      </td>
      <td style="text-align:center;"><input style="width:60%;" type="text" value="<?php echo $Record['OpeningStock']?>" id="EngineNo_<?php print $SNo; ?>" name="EngineNo[]"></td>
      <td style="text-align:center;"><input style="width:60%;" type="text" id="ChassisNo_<?php print $SNo; ?>" value="<?php echo $Record['ProductGroupName']; ?>" name="ChassisNo[]"></td>
      <td style="text-align:center;"><input style="width:60%;" type="text" id="LastPurchasePrice_<?php print $SNo; ?>"></td>
      <td style="text-align:center;">
        <input style="width:60%;" type="text" id="LastSalePrice_<?php print $SNo; ?>">
        <input type="hidden" id="hdnColourName_<?php print $SNo; ?>" name="ColourId[]">
      </td>
      <td><input style="width:100%; text-align:right;" type="text" id="Rate_<?php print $SNo; ?>" class="Rate" name="Rate[]" autocomplete="off"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="Quantity_<?php print $SNo; ?>" class="Quantity" value="<?php echo $Record['Quantity']; ?>" name="Quantity[]" autocomplete="off"></td>
      <td><input style="width:100%;" type="text" id="AvailableQty_<?php print $SNo; ?>"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="Amount1" class="Amount" name="Amount[]"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="DiscountAmount_<?php print $SNo; ?>" value="18" class="DiscountAmount" name="DiscountAmount[]"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="TaxPercentage_<?php print $SNo; ?>" class="TaxPercentage" name="TaxPercentage[]"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="FurtherTaxRate_<?php print $SNo; ?>" value="0" class="FurtherTaxRate" name="FurtherTaxRate[]"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="FurtherTaxAmt_<?php print $SNo; ?>" value="0" class="FurtherTaxAmt" name="FurtherTaxAmt[]"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="TaxAmount<?php print $SNo; ?>" value="0" class="TaxAmount" name="TaxAmount[]"></td>
      <td><input style="width:100%; text-align:right;" type="text" id="NetAmount<?php print $SNo; ?>" class="NetAmount" name="NetAmount[]"></td>
      <td>
        <input type="hidden" id="SaleCartId_<?php print $SNo; ?>" class="SaleCartId" name="SaleCartId[]">
        <i class="fa fa-times-circle remove" title="Delete" style="cursor:pointer; color:red;"></i>
      </td>
    </tr>
	<?php	}
	...
	<!--  <tr>
	 ...
	 <span style="cursor:pointer; color:darkgreen; font-weight:600;" id="addrow" class="fa fa-plus">Add Row</span>
        ...
        <tr id="cash-received">
          ...
          <td><div id="cashreceived" style='font-weight:600; text-align:right; color:#008000;'><input style="text-align:right" id="cash_received" type="text" name="cash_received" value="0"><input style="text-align:right" id="totaltax" type="hidden" value="0"></div></td>
        </tr>
                <tr id="cash-received">
...
function newRow() 
{
    ...
    cols += '<td><input style="width:100px;margin-top:1px;" type="text" id="txtCode'+ counter +'" name="ProductBarCode[]" class=""></td>';
    ...
    cols += '<td style="text-align:center;"><input style="width:60%; margin-top:1px;" type="text" id="LastPurchasePrice_'+ counter +'"></td>';
    cols += '<td style="text-align:center;"><input style="width:60%; margin-top:1px;" type="text" id="LastSalePrice_'+ counter +'"><input type="hidden" id="hdnColourName_'+ counter +'" name="ColourId[]"></td>';
    ...
    // New Further Tax fields added here
...
//      alert(data.id);
    ...
    //  console.log(nextTxtId);
     $("#EngineNo_"+nextTxtId).val(ui.item.OpeningStock);
    $("#ChassisNo_"+nextTxtId).val(ui.item.ProductGroupName);
