...
//          $FunctionName = 'CodexWorldWebsite';
      ...
      <div style="padding-top:-0.1em; font-size:12px; font-weight:600; text-align:center;">Period of <?php echo date('M d, Y', strtotime($this->input->get('StartDate'))).' &nbsp; - &nbsp;  '. date('M d, Y', strtotime($this->input->get('EndDate'))); ?>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelStockBalanceReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>&ProductId=<?php echo $this->input->get('ProductId'); ?>&BrandId=<?php echo $this->input->get('BrandId'); ?>&ProductGroupId=<?php echo $this->input->get('ProductGroupId'); ?>">Excel</a></li>
<!--          <li><a href="<?php // echo base_url()?>Export/ExportWordSaleDetailReport?StartDate=<?php // echo $this->input->get('StartDate') ?>&EndDate=<?php // echo $this->input->get('EndDate'); ?>">Word</a></li> -->
	...
	<td style="text-align:right; "><?php echo $SaleAmount; ?></td>
	<td style="text-align:right; "><?php echo $SaleReturnQuantity; ?></td>
	<td style="text-align:right; "><?php echo $SaleReturnAmount; ?></td>	
