    ...
    <br><br>
      ...
      <div style="padding-top:-0.1em; font-size:12px; font-weight:600; text-align:center;">Period of <?php echo date('M d, Y', strtotime($this->input->get('StartDate'))).' &nbsp; - &nbsp;  '. date('M d, Y', strtotime($this->input->get('EndDate'))); ?>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelStockTransferReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>&LocationId=<?php echo $this->input->get('LocationId'); ?>&ProductId=<?php echo $this->input->get('ProductId'); ?>&ColourId=<?php echo $this->input->get('ColourId'); ?>&EmployeeId=<?php echo $this->input->get('EmployeeId'); ?>">Excel</a></li>
