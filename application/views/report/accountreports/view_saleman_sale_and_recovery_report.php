...
//          $AccountGroupId = $LedgerReportRecord['AccountGroupId'];
            ...
            $ContactNumber = $LedgerReportRecord['ContactNumber'];
            $Address = $LedgerReportRecord['Address'];
	    ...
	    ?>
            <table style="width:100%; text-align: center; padding-left: 1px; border-bottom: 0px;">
              <thead>
                <tr style="border-bottom: 0px; border-top: 0px; border-right: 0px; border-left: 0px;">
                 <th style="font-family:Calibri; font-size:15px; padding-left:10px; height: 10px;" align="left" colspan="5">Saleman Name - <?php echo $ChartOfAccountTitle; ?></th>
                </tr>
                <tr style="border-bottom: 0px; border-top: 0px; border-right: 0px; border-left: 0px;">
                 <th style="font-family:Calibri; font-size:15px; padding-left:10px; height: 10px;" align="left" >Contact No - <?php echo $ContactNumber; ?></th>
                </tr>
                <tr style="border-bottom: 0px; border-top: 0px; border-right: 0px; border-left: 0px;">
                 <th style="font-family:Calibri; font-size:15px; padding-left:10px; height: 10px;" align="left">Address - <?php echo $Address; ?></th>
		            </tr>
                <tr>
                ...
                <tr style="background-color: #205081; color: #fff; height: 30px;border-bottom: 1px solid;">
                 <th style="border-bottom:1px solid; width:12%; font-family:Calibri; font-weight:bold; font-size:12px; text-align: center;">Date</th>
                 <th style="border-bottom:1px solid; width:33%; font-family:Calibri; font-weight:bold; font-size:12px; text-align: center;">Description</th>
                 <th style="border-bottom:1px solid; width:5%; font-family:Calibri; font-weight:bold; font-size:12px; text-align: center;">Ref No.</th>
                 <th style="border-bottom:1px solid; width:10%; font-family:Calibri; font-weight:bold; font-size:12px; text-align: center;">Sale</th>
                 <th style="border-bottom:1px solid; width:10%; font-family:Calibri; font-weight:bold; font-size:12px; text-align: center;">Sale Return</th>
                 <th style="border-bottom:1px solid; width:10%; font-family:Calibri; font-weight:bold; font-size:12px; text-align: center;">Recovery</th>
            ...
            // echo "</pre>"; exit;
              foreach($SubLedgerReport as $SubLedgerReportRecord) {
                ...
                {
                //print_r($SubLedgerReportRecord); exit;
              ...
              // foreach($SubLedgerReport as $SubLedgerReportRecord) {
              //   if($SubLedgerReportRecord['ChartOfAccountId'] == $LedgerReportRecord['ChartOfAccountId']
              //   && $SubLedgerReportRecord['SaleReturnId'] != Null) 
              //   {
              //     $saleReturnBalance += $SubLedgerReportRecord['Credit'];
              //   }
              // }
              ...
              $sDebit = round(($SaleId) ? $dDebit : 0);
              $sSaleReturn = ($SubLedgerReportRecord['SaleReturnId']) ? $dDebit : 0;
              $sCredit = (($SubLedgerReportRecord['SaleReturnId'] == Null || $SubLedgerReportRecord['SaleReturnId'] == "") && ($SaleId == Null || $SaleId == 0)) ? (($dCredit == 0.00) ? $dDebit : $dCredit) : 0;
              // if($balance == 415000){
              //   echo round($sCredit); exit;
              //  }
              if($balance == 0){
                $balance += $dBalance;
              }
              if($SaleId){
                ...
                //   echo "ok"; exit;
                //  }
                $balance = ($balance) ? $balance + $sDebit : $sDebit;
              }
              if($SubLedgerReportRecord['SaleReturnId']){
                $balance = ($balance) ? ($balance - $sSaleReturn) : $sSaleReturn;
              }
              if(($SubLedgerReportRecord['SaleReturnId'] == Null || $SubLedgerReportRecord['SaleReturnId'] == "") && ($SaleId == Null || $SaleId == 0)){
                $balance = ($balance) ? ($balance - $sCredit) : $sCredit;
              }
             
              //echo $balance; exit;
              $dTotal_Debit += $sDebit;
              $dTotalSaleReturn += $sSaleReturn;
              $dTotal_Credit += $sCredit;
	      ...
	      ?>
              <tr style="font-size:12px; height: 30px;">
                ...
                <td style="text-align: center;"><?php echo number_format($sDebit, 0); ?></td>
                <td style="text-align: center;"><?php echo number_format($sSaleReturn, 0); ?></td>
                <td style="text-align: center;"><?php echo number_format($sCredit, 0); ?></td> 
                <td style="text-align: center;"><?php echo number_format($balance, 0); ?></td>                
              </tr>
              <?php
              ...
              <tr style="font-size:12px; height: 30px;">
                ...
                <td style="font-weight: 700; text-align: center;"><?php echo number_format($dTotalSaleReturn,0); ?></td>
                <td style="font-weight: 700; text-align: center;"><?php echo number_format($dTotal_Credit,0); ?></td>
                <td style="font-weight: 700; text-align: center;"><?php echo number_format($balance,0); ?></td>
              </tr>
              <?php
              $sDebit = 0;
              $sCredit = 0;
