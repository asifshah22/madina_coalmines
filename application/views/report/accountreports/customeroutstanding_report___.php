...
//          $FunctionName = 'CodexWorldWebsite';
      ...
      <div style="padding-top:-0.1em; font-size:12px; font-weight:600; text-align:center;">Period of <?php echo date('M d, Y', strtotime($this->input->get('StartDate'))).' &nbsp; - &nbsp;  '. date('M d, Y', strtotime($this->input->get('EndDate'))); ?>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelCustomerOutstandingReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>&ChartOfAccountId=<?php echo $this->input->get('ChartOfAccountId'); ?>">Excel</a></li>
...
//				$dBalance = $Balance['Balance']; 
              ...
              <tr style="font-size:13px;">
                ...
                <td style="text-align:right;"><?php echo number_format($dBalance + $Amount,2); ?></td>
              </tr>
              <?php
              $i++;
              $SNo++;
              $DueAmount += ($dBalance + $Amount);
	      }
        } ?>
        <tr style="font-size:13px;">
