...
<head>
  ...
  <title>Balance Sheet Detail Report</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
      <div class="box box-info">
		...
		<?php
		 ...
		 $dTotal_CreditIncome = 0;
               ...
               <tr style="font-size:13px; font-weight:700;">
                ...
                <td style="width:10%;"><?php // echo number_format($dGrandTotal_Debit,2); ?></td>
               </tr>
               </tbody>
               <tr>
		...
		<td style="width:10%; font-family:Tahoma, Arial; text-align:right;"><?php //echo number_format($dTotal_DebitEquities,2); ?></td>
