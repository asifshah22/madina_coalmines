...
//              $CompanyName = $SubLedgerReportRecord['CompanyName'];
		...
		$dTransBalance = $dCredit - $dDebit;
		  ...
		  $dClosingBalance = $dTotal_Credit - $dTotal_Debit;			
	       ...
	       <?php echo '<a href="javascipt:void(0)" onclick="window.open(\''.base_url().'Generaljournal/ViewVoucher/'.$GeneralJournalId.'\',\'popUpWindow\',\'height=450,width=800,left=400,top=100,resizable=no,scrollbars=0,toolbar=no,menubar=no,location=no,directories=no, status=yes\');">'.$Reference.'</a>'; ?>
	      */
	      ?>
