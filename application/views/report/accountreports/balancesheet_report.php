...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <br><br>
      <h3 style="color:green;text-align: center;">Balance Sheet</h3>
      
      <div style="padding-top:-0.1em; font-size:12px; font-weight:600; text-align:center;">Upto: <?php echo date('M d, Y', strtotime($this->input->get('AsOfDate'))); ?>
      </div>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelBalanceSheetReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>">Excel</a></li>
          <li><a href="<?php echo base_url()?>Export/ExportWordBalanceSheetReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>">Word</a></li></ul>
          </span> &nbsp; </span>
      <hr style="color: #003eff; border-width: 1px; border-style: inset; display: block;">
		...
		<tr style="font-size:12px;">
                <td style="width:10%; font-family:Tahoma, Arial; text-align:left;  height:25px; padding-left:25px;"><?php echo $ChartOfAccountsCode. ' - '.$ChartOfAccountsTitle; ?></td>
                <td style="width:10%; font-family:Tahoma, Arial; text-align:right;"><?php echo number_format($dTotal_CreditLiabilities,2); ?></td>
		...
		?>
               <tr style="font-size:13px; font-weight:700;">
                ...
                <td style="width:5%; text-align:right;"><span style="border-bottom:solid 1px; border-top:1px solid;"><?php echo number_format($dGrandTotal_CreditLiabilities,2); ?></span></td>
		...
		<tr style="font-size:12px;">
                <td style="width:10%; font-family:Tahoma, Arial; text-align:left;  height:25px; padding-left:25px;"><?php echo $ChartOfAccountsCode. ' - '.$ChartOfAccountsTitle; ?></td>
                <td style="width:10%; font-family:Tahoma, Arial; text-align:right;"><?php echo number_format($dTotal_CreditEquities,2); ?></td>
		...
		?>
               <tr style="font-size:13px; font-weight:700;">
                ...
                <td style="width:5%; text-align:right;"><span style="border-bottom:solid 1px; border-top:1px solid;"><?php echo number_format($dGrandTotal_CreditEquities,2); ?></span></td>
                <td style="width:5%; text-align:right;"><?php // echo number_format($dGrandTotal_Credit,0); ?></td>
              </tr>
              </tbody>
             </table>
	     ...
	     <table border="0" cellspacing="0" cellpadding="5" style="width:100%;">
	      <tr style="font-size:13px; font-weight:700;">
	       ...
	       <td style="width:5%; text-align:right;"><span style="border-bottom:double 3px; border-top:1px solid;"><?php echo $Total = number_format($dGrandTotal_CreditLiabilities + $dGrandTotal_CreditEquities,2); //echo number_format($dTotal_Debit,0); ?></span></td>
	       <td style="width:5%;"></td>
	     </tr>
	     <tr>
...
<div class="form-group">
          ...
          <div class="col-sm-8">
                <input type="text" name="Subject" id="Subject" class="form-control" required="required" value="Balance Sheet Report upto: <?php echo date('M d, Y', strtotime($this->input->get('AsOfDate')));?> ">
          </div>
        </div> <br /><br />
...
<script>
  $(function(){
    $("#Submit").on('click', function(){
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>SendEmail/SendBalanceSheetReport',
        data: {EmployeeId:EmployeeId,OtherEmployee:OtherEmployee,Subject:Subject,Comments:Comments,Message:Message,AsOfDate:AsOfDate,CompanyId:CompanyId},
        type: 'post',
        dataType: 'html',
