...
header("Content-Disposition: attachment; filename = Customer Sale Summary Product Wise Report.xls");
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <br><br>
      <h3 style="color:green;text-align: center;">Customer Sales Summary Product Wise</h3>
