...
header("Content-Disposition: attachment; filename = Supplier Purchase Summary Product Wise.xls");
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Supplier Purchase Summary Report</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <br><br>
          <h3 style="color:green;text-align: center;">Supplier Purchase Summary Product Wise</h3>          
      ...
      <div style="height:30px;"></div>
		 ...
		 <th style="text-align:center;">Product</th>
	      ...
	      $SNo=1;
              if(isset($SupplierPurchaseDetail)) {
              foreach($SupplierPurchaseDetail as $VendorName => $VendorRecord) {
              ?>
		<tr>
		 <td colspan="5" style="text-align:left; color:#2489c5;"><h4>Supplier: <?php echo $VendorName; ?></h4></td>
		 <?php
		 if(!empty($VendorRecord) ) {
                 foreach($VendorRecord as $row) {
		 ?>
                </tr>
		 ...
		 <td style="text-align:right;"><?php echo number_format($row['DeductionRawMaterial'],0); ?></td>
		...
		<tr style="font-size:12px;  font-weight:600;">
		 <td colspan="2" style="text-align:right;">Supplier Total:</td>
                 <td style="text-align:right;"><?php echo $TotalWeight; ?></td>
                 <td><?php echo number_format($TotalDeductionRawMaterial,0); ?></td>
    ...
    $GrandDeductionRawMaterial = $TotalDeductionRawMaterial;
		...
		<tr style="font-size:12px;  font-weight:600;">
		 <td colspan="2" style="text-align:right;">Grand Total:</td>
                 ...
                 <td style="text-align:right;"><?php // echo number_format($GrandDeductionRawMaterial,0); ?> </td>
