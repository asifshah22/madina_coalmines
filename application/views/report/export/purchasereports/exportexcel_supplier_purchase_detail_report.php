...
header("Content-Disposition: attachment; filename = Supplier Purchase Detail Report.xls");
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Supplier Purchase Detail Report</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <br><br>
          <h3 style="color:green;text-align: center;">Supplier Purchase Detail</h3>
      ...
      <div style="height:30px;"></div>
		 ...
		 <th style="text-align:center;">Deduction Raw Material</th>
	      ...
	      $SNo=1;
              ...
              ?>
		<tr>
		 <td colspan="12" style="text-align:left; color:#2489c5;"><h4>Supplier: <?php echo $VendorName; ?></h4></td>
		 <?php
		...
		<tr style="font-size:12px;  font-weight:600;">
		 <td colspan="3" style="text-align:right;">Supplier Total:</td>
                 <td style="text-align:right;"><?php echo $TotalWeight; ?></td>
		 <td style="text-align:right;"><?php echo $TotalDeductionRawMaterial; ?></td>
		 ...
		 <td style="text-align:right;"></td>
		 <td style="text-align:right;"><?php echo number_format($TotalFEDAmount,2); ?></td>
