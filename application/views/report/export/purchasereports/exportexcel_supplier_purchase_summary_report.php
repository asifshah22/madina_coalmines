...
header("Content-Disposition: attachment; filename = Supplier Purchase Summary Report.xls");
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <br><br>
          <h3 style="color:green;text-align: center;">Supplier Purchase Summary</h3>          
      ...
      <div style="height:30px;"></div>
              ...
              if(isset($SupplierPurchaseSummary)) {
              
              foreach($SupplierPurchaseSummary as $Record) 
        {     
              ?>
              <tr style="font-size:13px;">
               <td style="text-align:center;"><?php echo $SNo; ?></td>
               <td style="text-align:left;"><?php echo $Record['VendorName']?></td>
               <td style="text-align:right;"><?php echo $Record['Weight']?></td>
