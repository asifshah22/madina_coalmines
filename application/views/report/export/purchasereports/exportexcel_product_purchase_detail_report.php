...
header("Content-Disposition: attachment; filename = Product Purchase Detail Report.xls");
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Product Purchase Detail Report</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <br><br>
          <h3 style="color:green;text-align: center;">Product Purchase Detail</h3>
      ...
      <div style="height:30px;"></div>
	      ...
	      $TotalNetAmount += $Record['NetAmount'];
              ...
              <tr style="font-size:13px;">
               ...
               <td style="font-weight:700; text-align:right;">&nbsp;<?php echo $TotalQuantity; ?></td>
