...
header("Content-Disposition: attachment; filename = Chart of Account Report.xls");
?>
<!DOCTYPE html>
<html>
<head>
      ...
      <div class="box box-info">
        <div class="col-md-12 col-xs-12">               
          <center>
            ...
            <h2 style="color:black; font-family:Georgia; font-weight:600;" class="box-title">Hilife Electronics
            </h2>
