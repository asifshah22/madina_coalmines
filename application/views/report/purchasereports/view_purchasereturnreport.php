...
//          $FunctionName = 'CodexWorldWebsite';
      ...
      <div style="padding-top:-0.1em; font-size:12px; font-weight:600; text-align:center;">Period of <?php echo date('M d, Y', strtotime($this->input->get('StartDate'))).' &nbsp; - &nbsp;  '. date('M d, Y', strtotime($this->input->get('EndDate'))); ?>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelPurchaseReturnReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>&VendorId=<?php echo $this->input->get('VendorId'); ?>&ProductId=<?php echo $this->input->get('ProductId'); ?>&LocationId=<?php echo $this->input->get('LocationId'); ?>&PurchaseType=<?php echo $this->input->get('PurchaseType'); ?>&ColourId=<?php echo $this->input->get('ColourId'); ?>&CategoryId=<?php echo $this->input->get('CategoryId'); ?>&ProductGroupId=<?php echo $this->input->get('ProductGroupId'); ?>&BrandId=<?php echo $this->input->get('BrandId'); ?>">Excel</a></li>
