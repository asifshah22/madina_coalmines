    ...
    <br><br>
      ...
      <div style="padding-top:-0.1em; font-size:12px; font-weight:600; text-align:center;">Period of <?php echo date('M d, Y', strtotime($this->input->get('StartDate'))).' &nbsp; - &nbsp;  '. date('M d, Y', strtotime($this->input->get('EndDate'))); ?>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelPurchaseDetailReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>&VendorId=<?php echo $this->input->get('VendorId'); ?>&ProductId=<?php echo $this->input->get('ProductId'); ?>&LocationId=<?php echo $this->input->get('LocationId'); ?>&PurchaseType=<?php echo $this->input->get('PurchaseType'); ?>&ColourId=<?php echo $this->input->get('ColourId'); ?>&CategoryId=<?php echo $this->input->get('CategoryId'); ?>&ProductGroupId=<?php echo $this->input->get('ProductGroupId'); ?>&BrandId=<?php echo $this->input->get('BrandId'); ?>">Excel</a></li>
<!--          <li><a href="<?php // echo base_url()?>Export/ExportWordPurchaseDetailReport?StartDate=<?php // echo $this->input->get('StartDate') ?>&EndDate=<?php // echo $this->input->get('EndDate'); ?>">Word</a></li> -->
</ul>
          </span> &nbsp; </span>
...
//    	if($AllPurchaseReport) {
  ...
  <th style="padding:5px;">P. ID</th>
	...
	<th style="text-align:left; padding:5px;">Item Name</th>
	<th style="text-align:left; padding:5px;">Brand</th>
	<th style="text-align:left; padding:5px;">UOM</th>
	...
	<th style="text-align:center; padding:5px;">Value</th>
  <th style="text-align:center; padding:5px;">GST Rate</th>
	<th style="text-align:center; padding:5px;">GST Amount</th>
	<th style="text-align:center; padding:5px;">VALUE INCL ST</th>
	<th style="text-align:center; padding:5px;">Discount</th>
	<th style="text-align:center; padding:5px;">O.DISCOUNT</th>
	<th style="text-align:center; padding:5px;">WH AMOUNT</th>
  ...
  <!-- <th style="padding:5px;">Date</th> -->
	...
	<td style="text-align:left;"><?php echo date('M d, Y', strtotime($AllPurchasesRecord['PurchaseDate'])); ?></td>
	...
	<td style="text-align:right;"><?php echo ($AllPurchasesRecord['Discount']); ?></td>
	<td style="text-align:right;"><?php echo ($AllPurchasesRecord['ODiscount']); ?></td>
	<td style="text-align:right;"><?php echo ($AllPurchasesRecord['HoldingAmount']); ?></td>
