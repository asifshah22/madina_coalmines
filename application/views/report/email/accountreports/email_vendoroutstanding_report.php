      ...
      <div class="box box-info">
        <div class="col-md-12 col-xs-12">               
	      ...
	      <h2 style="color:darkblue; font-family:Georgia; font-weight:600;" class="box-title">Sunny Paper Mills</h2>
              <h3 style="color:green;" class="box-title">Vendor Outstanding Report</h3>
	      <hr style="color: #003eff; border-width: 1px; border-style: inset; display: block;">
	      <div style="padding-top:-0.1em; font-size:12px; font-weight:600; text-align:left;">Upto: <?php echo date('M d, Y', strtotime($this->input->get('EndDate'))); ?></div>  <br>
            </div>
          </center>
