...
<head>
  ...
  <title>Product Sale Detail Report</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
      <div class="box box-info">
        ...
        <br><br>
        <h3 style="color:green;text-align: center;" class="box-title">Product Sale Detail</h3>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelProductSaleDetailReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>">Excel</a></li>
          <li><a href="<?php echo base_url()?>Export/ExportWordProductSaleDetailReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>">Word</a></li></ul>
          </span> &nbsp; </span>
        ...
        <hr style="color: #003eff; border-width: 1px; border-style: inset; display: block;">
          ...
          <center>
		    ...
		    <td style="padding-left:10px; padding-top:10px; width: 6%; text-align: center;"><?php echo $SNo; ?></td>
              ...
              <tr>
                ...
                <td style="text-align: right;"><?php echo "<b>" . number_format($Weight,2) . "</b>"; ?></td>
                <td style="text-align: right;"><?php echo "<b>" . number_format($Total,2) . "</b>"; ?></td>
              </tr>  
              </tbody>
              </table>
            </div>
...
<div class="form-group">
          ...
          <div class="col-sm-8">
                <input type="text" name="Subject" id="Subject" class="form-control" required="required" value="Product Sale Detail Report from: <?php echo date('M d, Y', strtotime($this->input->get('StartDate')));?> To <?php echo date('M d, Y', strtotime($this->input->get('EndDate')));?> ">
          </div>
        </div> <br /><br />
