...
<head>
  ...
  <script src="<?php echo base_url(); ?>plugins/jQuery/jquery-2.2.3.min.js"></script>
   <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>lib/css/font-awesome/bootstrap.min.css">
  <!-- Ionicons -->
...
?>
 ...
 <section class="invoice">
  <!-- title row -->
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <table border="0" class="table table-striped">
         <thead>
         <tr>
           <td style="text-align:left; font-size: 16px; font-weight:600;">INV: <?php echo $SalesInvoiceDetailReport[0]['InvoiceNo']; ?> <br> Invoice Date: <?php echo $sInvoiceDate; ?></td>
           <td style="text-align:right; font-size: 16px; font-weight:600;">NTN No: <?php echo $SalesInvoiceDetailReport[0]['NTN']; ?></td>
         </tr>
         <tr>
           <td colspan="2" style="text-align:center; font-size: 26px; font-weight:bold;">BILL / INVOICE</td>
         </tr>
         </thead>
        </table>   
      </div>
    ...
    <div class="row">
         ...
         <table class="table table-bordered" style="width: 100%" id="table-basic">
          <thead>
           <tr>
            ...
            <th style="font-size:15px; font-weight:600; text-align:center; border-bottom:1px solid; border-top:1px solid; width:auto;">PARTICULARS</th>
            ...
            <th style="font-size:15px; font-weight:600; text-align:center; border-bottom:1px solid; border-top:1px solid; width:auto;">QTY</th>
	  ...
	  ?>
          <tr>
            ...
            <?php  if($sMfgDate=="true") { ?> 
            <td style="font-size:14px; font-weight:600; text-align:center;"><?php echo $MFgdate = $row['ManufactureDate'] != '' ? $row['ManufactureDate'] : ''; ?></td>
            <?php } if($sExpiryDate=="true") { ?>
            <td style="font-size:14px; font-weight:600; text-align:center;"><?php echo $ExpDate = $row['ExpireDate'] != '' ? $row['ExpireDate'] : ''; ?></td>
            <?php } if($sMfgName=="true") { ?>
            <td style="font-size:14px; font-weight:600; text-align:center;"><?php echo $MfgName = $row['ManufactureName'] != '' ? $row['ManufactureName'] : ''; ?></td>
            <?php } ?>
            <td style="font-size:14px; font-weight:600; text-align:center;"><?php echo $row['UoM'] != 0 ? number_format(($row['UoM'] * $row['Rate']),2) : number_format($row['Rate'],2); ?></td>
           ...
           <tr>
             <td style="text-align:right; font-size:14px; font-weight:bold;"></td>
             <td style="text-align:right; font-size:14px; font-weight:bold;"></td>
             ...
             <?php } ?>
             <td style="text-align:right; font-size:14px; font-weight:bold;"></td>
             <td style="text-align:right; font-size:14px; font-weight:bold; text-align:right;">Total Rs.</td>
             <td style="text-align:left; font-size:14px; font-weight:bold; text-align:center;"><?php echo number_format($TotalAmount,2); ?></td>
           </tr>
          </tbody>
        </table>
        </div>
    ...
    <div style="text-align: right; border:0px solid;" class="col-xs-4">
    <div class="row">
 ...
 <section class="invoice">
    ...
    <div class="row">
        <div class="col-xs-12">
         ...
         <table border="0" class="table table-striped">
          <thead>
          <tr>
            <td style="text-align:left; font-size: 16px; font-weight:600;">Delivery Challan <?php echo $SalesInvoiceDetailReport[0]['InvoiceNo']; ?></td>
    ...
    <div class="row">
	  ...
	  if(isset($SalesInvoiceDetailReport)) {
          ...
          if($sProductName == "true")
          $Particulars = $row['ProductGroupName'].' - '.$row['ProductName'];
          else
          $Particulars = $row['ProductGroupName'];         
	  ?>
          <tr>
