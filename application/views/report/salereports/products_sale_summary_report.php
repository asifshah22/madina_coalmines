...
<head>
  ...
  <title>Product Sale Summary Report</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <div class="box box-info">
        ...
        <br><br>
        <h3 style="color:green;text-align: center;" class="box-title">Product Sale Summary</h3>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>Export/ExportExcelProductSaleSummaryReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>">Excel</a></li>
          <li><a href="<?php echo base_url()?>Export/ExportWordProductSaleSummaryReport?StartDate=<?php echo $this->input->get('StartDate') ?>&EndDate=<?php echo $this->input->get('EndDate'); ?>">Word</a></li></ul>
          </span> &nbsp; </span>
		 ...
		 <th style="text-align:center;">Net Amount</th>
	      ...
	      {     
              ...
              <tr style="font-size:13px;">
               ...
               <td style="text-align:right;"><?php echo number_format($Record['Weight'],2); ?></td>
	       ...
	       <td style="text-align:right;"><?php echo number_format($Record['GSTAmount'],2); ?></td>
	       <td style="text-align:right;"><?php echo number_format($Record['FEDAmount'],2); ?></td>
	      ...
	      $TotalNetAmount += $Record['NetAmount'];
	       ...
	       <td style="font-weight:700; text-align:right;" colspan="2">Total:</td>
               <td style="font-weight:700; text-align:right;">&nbsp;<?php echo number_format($TotalWeight,2); ?></td>
	       <td style="font-weight:700; text-align:right;">&nbsp;<?php echo number_format($TotalQuantity,2); ?></td>
               <td style="font-weight:700; text-align:right;"><?php echo number_format($TotalAmount,2); ?></td>
	       <td style="font-weight:700; text-align:right;"><?php echo number_format($TotalGSTAmount,2); ?></td>
	       <td style="font-weight:700; text-align:right;"><?php echo number_format($TotalFEDAmount,2); ?></td>
...
<div class="form-group">
          ...
          <div class="col-sm-8">
                <input type="text" name="Subject" id="Subject" class="form-control" required="required" value="Product Sale Summary Report from: <?php echo date('M d, Y', strtotime($this->input->get('StartDate')));?> To <?php echo date('M d, Y', strtotime($this->input->get('EndDate')));?> ">
          </div>
        </div> <br /><br />
...
<script>
  $(function(){
    $("#Submit").on('click', function(){
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>SendEmail/SendProductSaleSummaryReport',
