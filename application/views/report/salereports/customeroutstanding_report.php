    ...
    <div class="wrapper">
      <div class="box box-info">
        <div class="col-md-12 col-xs-12">               
	      ...
	      <h2 style="color:darkblue; font-family:Georgia; font-weight:600;" class="box-title">Sunny Paper Mills</h2>
	    ...
	    <div style="height:30px;"></div>
		 ...
		 <th style="text-align:center;">Debit</th>
	      ...
	      {     
	       ...
	       <td style="text-align:right;"><?php echo number_format($Record['Credit'],2); ?></td>
              </tr>
              <?php $SNo++;
	      ...
	      $TotalCredit += $Record['Credit'];
	       ...
	       <td style="font-weight:700; text-align:right;" colspan="2">&nbsp; Grand Total:</td>
               <td style="font-weight:700; text-align:right;">&nbsp;<?php echo number_format($TotalDebit,2); ?></td>
	       <td style="font-weight:700; text-align:right;">&nbsp;<?php echo number_format($TotalCredit,2); ?></td>
              </tr> 
              </tbody>
              </table>
            </div>
