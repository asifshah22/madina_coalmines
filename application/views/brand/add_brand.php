      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="ProductForm" class="form-horizontal" enctype="multipart/form-data" action='<?php echo base_url("Brand/SaveBrand"); ?>' method="post"> 
                    <div class="box-body">
                      <div class="form-group">
                        <label for="BrandName" class="col-sm-1 control-label">Brand Name:</label>
                          <div class="col-sm-4">
                            <input type="text" name="BrandName" id="" class="form-control" value="">
                          </div>
                      </div><!-- /.form-group -->
                    </div>
