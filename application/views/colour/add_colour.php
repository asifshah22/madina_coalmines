        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Colour</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="ProductForm" class="form-horizontal" enctype="multipart/form-data" action='<?php echo base_url("Colour/SaveColour"); ?>' method="post"> 
                    <div class="box-body">
                      <div class="form-group">
                        <label for="ColourName" class="col-sm-1 control-label">Colour Name:</label>
                          <div class="col-sm-4">
                            <input type="text" name="ColourName" id="" class="form-control" value="">
                          </div>
                      </div><!-- /.form-group -->
                    </div>
