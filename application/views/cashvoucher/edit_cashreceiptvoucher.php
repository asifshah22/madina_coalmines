    ...
    <section class="content">
	 ...
	 <div class="box box-info">
         <div  class="box-header with-border">
          <h3 class="box-title text-light-blue">Update Cash Receipt Voucher</h3>
         </div>
	
         <form role="form" id="GeneralJournalForm" method="post" action='<?php echo site_url("CashReceiptVoucher/UpdateCRV"); ?>'>
	 <input type="hidden" name="CashCOA" value="1">    
	 <div class="box-body">
	  <div class="row invoice-info">
	    <div class="col-sm-4 form-group">
	      <strong>Voucher #:</strong><br>
		<?php echo $CashReceipt->ReferencePrefix.''.$CashReceipt->Reference; ?>
            </div>
	    <div class="col-sm-4 form-group">
	      <strong>Transaction Date:</strong><br>
		<div class="input-group date">
		 <input style="width:220px;" class="form-control" name="TransactionDate" id="datepicker" type="text" value="<?php echo date("m/d/Y", strtotime($CashReceipt->TransactionDate)); ?>" autocomplete="off">
		</div>
	    </div>
	  </div>
	  </div>
	  ...
	  <!-- Voucher Detail Entries Block -->
		...
		<th><span class="fa fa-trash"></span></th>
	      ...
	      <?php
              ...
              foreach($CashReceiptEntries as $Record)
	      {
		...
		<table border="0" cellspacing="2" cellpadding="2" width="100%">
		 <tbody>
		  <tr>
		    <td colspan="7">
		    <input type="hidden" name="GeneralJournalId" value="<?php echo $CashReceipt->GeneralJournalId; ?>">
		    <span style="cursor:pointer; color:darkgreen; font-weight:600;" id="addRow" class="fa fa-plus">Add Row</span></td>
		  </tr>
		  <tr>
		    <td colspan="4"></td>
		    <td style="text-align:left; width:100px; padding-right:1px; font-weight:600; border:0px solid;"><div id="divTotal_Credit"><?php echo $TotalCredit; ?></div></td>
		  </tr>
		 </tbody>
		</table>
	    </div>		      
	  ...
	  <div class="box-body">
		...
		<label for="VoucherNote" class="col-sm-2 control-label">Voucher Note:</label>
		 <div class="input-group">
		   <textarea name="VoucherNote" class="form-control" rows="2" cols="60"><?php echo $CashReceipt->VoucherNote;?></textarea>
		 </div>
	      </address>
	     </div>
	     <div class="col-md-2">
