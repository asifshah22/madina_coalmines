    ...
    <section class="content">
	 ...
	 <div class="box box-info">
         <div  class="box-header with-border">
          <h3 class="box-title text-light-blue">View Cash Receipt Voucher</h3>
         </div>
	 ...
	 <div class="box-body">
	  <div class="row invoice-info">
		...
		<div class="input-group date">
		  <?php echo date('M d, Y', strtotime($CashReceipt->TransactionDate)); ?>
		</div>
	    </div>
	  </div>
	  </div>
	  ...
	  <!-- Voucher Detail Entries Block -->
		...
		<td style="padding:3px; text-align:left;">
	       ...
	       <tr>                
                <td colspan="4"></td>
                <td style="font-weight:600; text-align:right; color:#3333CC;"><?php echo number_format($CashReceipt->TotalCredit,2); ?></td>
               </tr>
            </table>
	      ...
	      <div class="form-group">
	       <label for="VoucherNote" class="col-sm-2 control-label"><strong>Voucher Note:</strong></label>
               <div class="input-group">
                <?php echo $CashReceipt->VoucherNote != '' ? $CashReceipt->VoucherNote : '&nbsp;'; ?> 
               </div>
	      </div>
	     </div>
	     <?php if ($CashReceipt->EntryType != '1') { ?>
	    <div class="col-md-2">
	     <a href="<?php echo base_url(); ?>CashReceiptVoucher/AddCRV" class="btn btn-block btn-primary">Add Record</a>
	    </div>
	    <?php } ?>
	    <div class="col-md-2">
	     <a href="<?php echo base_url(); ?>CashReceiptVoucher/" class="btn btn-block bg-orange">Back to Main</a>
	    </div>
	    </div>
	   </div>
      </div>
