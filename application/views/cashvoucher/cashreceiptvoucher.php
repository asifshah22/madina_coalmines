        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <?php echo "<font style=color:#00468E; font-weight:bold text-align:center;>".$this->session->flashdata('record_added')."</font>"; ?>
              <table id="cashreceiptvoucher-grid" class="table table-striped" class="table table-bordered table-striped"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%" >
                  <thead>
                  <tr>
	      ...
	      if ($AccountsRoles[0]['AddRoles']==1) { ?>
              <div class="box-footer col-md-2 col-sm-4 col-xs-6">
                <a href="<?php echo base_url(); ?>CashReceiptVoucher/AddCRV" class="btn btn-primary">Add Record</a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-body -->
