 ...
 <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title text-light-blue">View Bank Payment Voucher</h3>
            </div>
	 ...
	 <div class="row invoice-info">
		...
		<?php echo date('M d, Y', strtotime($BankPayment->TransactionDate)); ?>
	    </div>
	     <div class="col-sm-3 form-group">
	    <strong>Bank Account:</strong><br>
	    <?php echo $BankPayment->AccountTitle; ?>
            </div>
	 <div class="col-sm-3 form-group">
	    <strong>Bank Cheque:</strong><br>
	    <?php echo $BankPayment->ChequeNumber != 0 ? $BankPayment->ChequeNumber : 'Without Cheque'; ?>
	 </div>
	 </div> 
      </div>
      <div class="row">
		...
		<td style="padding:3px; text-align:left;">
	       ...
	       <tr>                
                <td colspan="4"></td>
                <td style="font-weight:600; text-align:right; color:#3333CC;"><?php echo number_format($BankPayment->TotalDebit,2); ?></td>
               </tr>
       ...
       <div class="col-md-12">
	     ...
	     <label for="VoucherNote" class="col-sm-2 control-label"><strong>Voucher Note:</strong></label>
             <div class="input-group">
               <?php echo $BankPayment->VoucherNote != '' ? $BankPayment->VoucherNote : '&nbsp;'; ?> 
             </div>
         </div>
       </div>
	<?php if ($BankPayment->EntryType != '1') { ?>
       <div class="col-md-2">
	 <a href="<?php echo base_url(); ?>BankPaymentVoucher/AddBPV" class="btn btn-block btn-primary">Add Record</a>
       </div>
	<?php } ?>
       <div class="col-md-2">
	<a href="<?php echo base_url(); ?>BankPaymentVoucher/" class="btn btn-block bg-orange">Back to Main</a>
       </div>
      </div>
      <!-- /.row -->
      </div>
