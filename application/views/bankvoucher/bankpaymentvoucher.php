...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-book"></i>&nbsp;Bank Payments Voucher</h1>
    </section>
      ...
      <div class="row">
	    ...
	    <!-- <h3 class="box-title">Total Records (<?php // print count($GetAllGeneralJournal); ?>)</h3> -->
            ...
            <?php echo "<font style=color:#00468E; font-weight:bold text-align:center;>".$this->session->flashdata('record_added')."</font>"; ?>
              <table id="bankpaymentvoucher-grid" class="table table-striped" class="table table-bordered table-striped"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%" >
                  <thead>
                  <tr>
	      ...
	      if ($AccountsRoles[0]['AddRoles']==1) { ?>
              <div class="box-footer col-md-2 col-sm-4 col-xs-6">
                <a href="<?php echo base_url(); ?>BankPaymentVoucher/AddBPV" class="btn btn-primary">Add Record</a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-body -->
