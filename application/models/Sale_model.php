  ...
  public function DebitRecord($CoAId)
  {
    ...
    public function SaveImportedSale($header, $items)
    {
        ...
        foreach ($items as $item) {
            ...
            $furtherTaxRate = !empty($item['further_tax_rate']) ? (float) $item['further_tax_rate'] : 0;
            $furtherTaxAmount = (float) $item['further_tax_amount'];
            ...
            $saleDetail = array(
                ...
                'Quantity' => $quantity,
                'Rate' => $rate,
                'DiscountAmount' => $gstRate,
                'Amount' => $amount,
                'TaxPercentage' => $gstAmount,
                'TaxAmount' => $discountAmount,
                'FurtherTaxRate' => $furtherTaxRate,
                'FurtherTaxAmt' => $furtherTaxAmount,
                'NetAmount' => $netAmount,
